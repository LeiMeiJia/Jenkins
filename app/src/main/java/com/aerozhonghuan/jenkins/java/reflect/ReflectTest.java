...
public class ReflectTest {
    ...
    public static void reflect() throws Exception {
        ...
        // AdminDao.class;
        // adminDao.getClass();
        // Class.forName("com.aerozhonghuan.jenkins.java.reflect.AdminDaoImpl"); // 优先考虑
        // ClassLoader.getSystemClassLoader().loadClass("com.aerozhonghuan.jenkins.java.reflect.AdminDaoImpl");
        Class clazz = Class.forName("com.aerozhonghuan.jenkins.java.reflect.AdminDaoImpl");
